...
public class GameManager : MonoBehaviour
{
    ...
    void CreateShield()
    {
        Instantiate(shieldPrefab, new Vector3(Random.Range(-horizontalScreenSize * 0.8f, horizontalScreenSize * 0.8f), Random.Range(-verticalScreenSize * 0.8f, verticalScreenSize * 0.8f), 0), Quaternion.identity);
    }
